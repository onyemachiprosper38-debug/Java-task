               ...
               System.out.println(Tones + "\nEnter any option to select: ");
                ...
                System.out.println(settings + "\n Enter an option to select: ");
                      ...
                      System.out.println(callDivert + "\nSelect 1 to enter: ");
                           int select = input.nextInt();  
                          switch (select){
                          case 1-> System.out.println("Call forwarded unavailable: ");
                         }
                       }
                      ...
                      System.out.println(Games + "\nSelect 1 to enter: ");
                           int select = input.nextInt();  
                          switch (select){
                          case 1-> System.out.println("Snake Game Activated: ");
                          case 2-> System.out.println("Soccer Activated: ");
                          case 3-> System.out.println("Danger Dash Activated: ");
                         }
                       }
                   ...
                   System.out.println(Calculator + "\nSelect 1 to enter: ");
                           int select = input.nextInt(); 
                          switch (select){
                          case 1-> System.out.println("Calculator Activated: "); 
                         }
                       }
                   ...
                   System.out.println(Reminders + "\nSelect 1 to enter: ");
                           int select = input.nextInt(); 
                          switch (select){
                          case 1-> System.out.println("Reminders Activated: "); 
                         }
                       }
                   ...
                   System.out.println(Profiles + "\nSelect 1 to enter: ");
                           int select = input.nextInt(); 
                          switch (select){
                          case 1-> System.out.println("Profiles Activated: "); 
                         }
                       }
